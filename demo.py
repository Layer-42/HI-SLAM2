...
def save_trajectory(hi2, traj_full, imagedir, output, start=0):
    ...
    save_traj_tum(ttraj_kf, f"{output}/traj/est_poses_kf.txt")  # same format as Splat-SLAM/WildGS-SLAM
    if traj_full is not None:
        ...
        save_traj_tum(ttraj_full, f"{output}/traj/est_poses_full.txt")  # same format as Splat-SLAM/WildGS-SLAM
